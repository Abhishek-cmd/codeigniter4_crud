		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<form method="POST" name="createForm" id="createForm" action="<?php echo base_url('/books/edit/'.$book['id']);?>">
							<div class="form-group">
								<label class="">Name</label>
								<input type="text" name="names" id="names" class="form-control <?php echo (isset($validation) && $validation->hasError('names')) ? 'is-invalid' : ''; ?>" value="<?php echo set_value('names', $book['name']);?>">
							...
							<div class="form-group">
								...
								<input type="text" name="author" id="author" class="form-control echo <?php (isset($validation) && $validation->hasError('author')) ? 'is-invalid' : '' ?>" value="<?php echo set_value('author', $book['author']);?>">
								<?php
							...
							<div class="form-group">
								...
								<input type="text" name="isbn_no" id="isbn_no" class="form-control" value="<?php echo set_value('isbn_no', $book['isbn']);?>">
							</div>
